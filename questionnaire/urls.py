...
urlpatterns = [
    ...
    path('questionnaires/import-docx/', dashboard_views.import_questionnaire_docx, name='import_questionnaire_docx'),
    ...
    path('survey/<uuid:questionnaire_id>/submit/', user_views.submit_response, name='submit_response'),
